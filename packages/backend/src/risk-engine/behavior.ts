...
const CATEGORY_KEYWORDS: Record<string, string[]> = {
  operations: ["operations", "ops", "expense", "vendor", "service", "invoice", "subscription"],
  infra: ["infra", "server", "hosting", "cloud", "node", "rpc", "database", "storage"],
  payroll: ["salary", "payroll", "team", "contractor", "developer", "designer"],
  growth: ["growth", "sales", "ads", "campaign", "distribution"],
  grants: ["grant", "grant program", "grant round", "scholarship"],
  marketing: ["marketing", "brand", "content", "promotion", "community campaign"],
  research: ["research", "audit", "analysis", "investigation", "testing"],
  community: ["community", "events", "moderation", "ambassador", "education"],
};
